...
/* BOOLEAN:INT (/localhome/kantonia/slate/benchmarks/parsec-3.0/pkgs/libs/glib/src/tests/gobject/testmarshal.list:2) */
void
...
/* STRING:INT (/localhome/kantonia/slate/benchmarks/parsec-3.0/pkgs/libs/glib/src/tests/gobject/testmarshal.list:3) */
void
