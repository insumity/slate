...
tbb_bin="/localhome/kantonia/slate/benchmarks/parsec-3.0/pkgs/libs/tbblib/obj/amd64-linux.gcc/build/linux_intel64_gcc_cc5.4.0_libc2.23_kernel4.4.0_debug" #
if [ -z "$CPATH" ]; then #
