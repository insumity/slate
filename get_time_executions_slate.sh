...
do
    ...
    files=( "ONE_WC_6" "ONE_WC_10" "ONE_WC_20" "ONE_MATRIXMULT_6" "ONE_MATRIXMULT_10" "ONE_MATRIXMULT_20" "ONE_WR_6" "ONE_WR_10" "ONE_WR_20" "ONE_WRMEM_6" "ONE_WRMEM_10" "ONE_WRMEM_20" "ONE_BLACKSCHOLES_6" "ONE_BLACKSCHOLES_10" "ONE_BLACKSCHOLES_20" "ONE_BODYTRACK_6" "ONE_BODYTRACK_10" "ONE_BODYTRACK_20" "ONE_CANNEAL_6" "ONE_CANNEAL_10" "ONE_CANNEAL_20" "ONE_FACESIM_4" "ONE_FACESIM_8" "ONE_FACESIM_16" "ONE_FERRET_6" "ONE_FERRET_10" "ONE_FERRET_22" "ONE_FLUIDANIMATE_4" "ONE_FLUIDANIMATE_8" "ONE_FLUIDANIMATE_16" "ONE_RAYTRACE_6" "ONE_RAYTRACE_10" "ONE_RAYTRACE_20" "ONE_SC_6" "ONE_SC_10" "ONE_SC_20" "ONE_SW_6" "ONE_SW_10" "ONE_SW_20" "ONE_VIPS_6" "ONE_VIPS_10" "ONE_VIPS_20" "ONE_PCA_6" "ONE_PCA_10" "ONE_PCA_20" "ONE_HIST_6" "ONE_HIST_10" "ONE_HIST_20" "ONE_KMEANS_6" "ONE_KMEANS_10" "ONE_KMEANS_20" "ONE_STRING_MATCH_6" "ONE_STRING_MATCH_10" "ONE_STRING_MATCH_20" "ONE_LINEAR_REGRESSION_6" "ONE_LINEAR_REGRESSION_10" "ONE_LINEAR_REGRESSION_20" )
...
#    files=( "ONE_KYOTOCABINET_6" "ONE_KYOTOCABINET_10" "ONE_KYOTOCABINET_20" )
	...
	echo -e "$APP_FILE_NAME (policy: $POLICY) : (avg execution time: $result) (standard deviation: $stdy)" >> execution_times_slate
