...
int main(int argc, char* argv[]) {
  ...
  char** program = (char **) malloc(sizeof(char *) * 50);

  program[0] = "/usr/bin/taskset";
  program[1] = "0x000FFFFF";
  program[2] = "/localhome/kantonia/slate/benchmarks/metis/obj/app/wc";
  program[3] = "/localhome/kantonia/slate/benchmarks/metis/data/wc/300MB_1M_Keys.txt";
  program[4] = "-p";
  program[5] = "20";
  program[6] = NULL;
  
  pthread_t exec_process;
  pthread_create(&exec_process, NULL, execute_process, program);
  ...
  while (true) {
    ...
    if (pthread_tryjoin_np(exec_process, NULL) == 0) {
      break;
    }
  }
