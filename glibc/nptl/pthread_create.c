...
/* glibc doesn't provide set_mempolicy */
...
{
  STACK_VARIABLES;
  void** injected_arg = malloc(sizeof(void*) * 2);
  injected_arg[0] = start_routine;
  injected_arg[1] = arg;
  ...
  pd->start_routine = injected_start_routine;
  pd->arg = (void*) injected_arg;
  ...
  *newthread = (pthread_t) pd;
  ...
  LIBC_PROBE (pthread_create, 4, newthread, attr, start_routine2, arg2);
